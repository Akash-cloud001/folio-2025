...
const Home = () => {
  ...
  return (
    <section onMouseMove={handleMouseMove} className="home-container relative h-dvh w-full flex flex-col-reverse md:flex-row items-start justify-center md:items-center md:justify-center overflow-hidden padding-top-nav">
      <article className="hero-left w-full md:w-3/4 h-full ff-betatron flex items-start justify-center pl-2 md:pl-6 flex-col relative z-[1] select-none -top-[2%] sm:-top-[15%] -translate-y-1/2 md:translate-y-0  md:top-auto">
      ...
      <aside id="hero-canvas" className="hero-right relative -top-8 sm:-top-[7%] md:top-auto rotate-90 md:rotate-0 w-[100%] h-[100vw]  md:h-dvh md:w-[30%] lg:w-[30%]  xl:w-1/4 ">
        <Canvas
          gl={{
