...
const YearCard = ({year, content, imgUrl, className, scale=1, }) => {
  return (
    <article style={{transform: `scale(${scale})`}} className={`${className} max-w-[360px] max-h-[275px] !w-full !h-[275px] flex items-start pt-6 justify-center  backdrop-blur-sm rounded-xl border border-white/20 overflow-hidden  bg-black px-4`}>
